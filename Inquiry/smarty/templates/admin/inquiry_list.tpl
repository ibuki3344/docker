...
<a href="./inquiry_list.php?sort=id&{$uri_params|unescape}&p={$back_page}" class="btn btn-nomal">back </a>
{else}
...
<a href="./inquiry_list.php?sort=id&{$uri_params|unescape}&p={$next_page}" class="btn btn-nomal">next</a><br>
